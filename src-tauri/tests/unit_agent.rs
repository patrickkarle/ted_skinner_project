...
fn test_agent_new_initializes_correctly() {
    ...
    let agent = Agent::new(manifest, api_key, None, None, None);
...
fn test_agent_new_with_empty_manifest() {
    ...
    let _agent = Agent::new(manifest, api_key, None, None, None);
...
async fn test_run_workflow_with_empty_manifest() {
    ...
    let api_key = "test-key".to_string();
    let mut agent = Agent::new(manifest, api_key, None, None, None);
